...
void TaxiPark::loadData() {
    ...
    QFile fsDriver(dir.absoluteFilePath("dataBase/drivers/driversDependent.txt")); //инфо о зависимых водител€х
    QFile fsSalary(dir.absoluteFilePath("dataBase/finance/salaryDependent.txt")); //инфо о зависимых водител€х
    ...
    fsDriver.setFileName(dir.absoluteFilePath("dataBase/drivers/driversIndependent.txt")); //инфо о независимых водител€х
